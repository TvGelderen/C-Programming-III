// Generated by Bisonc++ V6.02.04 on Sun, 28 Mar 2021 19:55:54 +0000
...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 3}, // 2: input ->  input line prompt
     {259, 2}, // 3: input ('\x0a') ->  input '\x0a'
     {260, 0}, // 4: prompt ->  <empty>
     {261, 2}, // 5: line ('\x0a') ->  expr '\x0a'
     {261, 2}, // 6: line (errTok_) ->  errTok_ '\x0a'
     {262, 1}, // 7: expr ->  number
     {262, 3}, // 8: expr ('+') ->  expr '+' expr
     {262, 3}, // 9: expr ('-') ->  expr '-' expr
     {262, 3}, // 10: expr ('*') ->  expr '*' expr
     {262, 3}, // 11: expr ('/') ->  expr '/' expr
     {262, 2}, // 12: expr (UMINUS) ->  '-' expr
     {263, 1}, // 13: number (NUMBER) ->  NUMBER
     {264, 1}, // 14: input_$ ->  input
};
