// Generated by Bisonc++ V6.04.03 on Tue, 06 Apr 2021 13:26:48 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {274, 2}, // 4: line (EXIT) ->  EXIT '\x0a'
     {274, 2}, // 5: line (LIST) ->  LIST '\x0a'
     {274, 2}, // 6: line (errTok_) ->  errTok_ '\x0a'
     {274, 1}, // 7: line ('\x0a') ->  '\x0a'
     {275, 1}, // 8: expr (NUMBER) ->  NUMBER
     {275, 1}, // 9: expr (IDENT) ->  IDENT
     {275, 2}, // 10: expr (uMinus) ->  '-' expr
     {275, 2}, // 11: expr (uNegate) ->  '~' expr
     {275, 3}, // 12: expr ('*') ->  expr '*' expr
     {275, 3}, // 13: expr ('/') ->  expr '/' expr
     {275, 3}, // 14: expr ('%') ->  expr '%' expr
     {275, 3}, // 15: expr ('+') ->  expr '+' expr
     {275, 3}, // 16: expr ('-') ->  expr '-' expr
     {275, 3}, // 17: expr ('<') ->  expr '<' expr
     {275, 3}, // 18: expr ('>') ->  expr '>' expr
     {275, 3}, // 19: expr ('&') ->  expr '&' expr
     {275, 3}, // 20: expr ('^') ->  expr '^' expr
     {275, 3}, // 21: expr ('|') ->  expr '|' expr
     {275, 3}, // 22: expr ('(') ->  '(' expr ')'
     {275, 3}, // 23: expr ('=') ->  expr '=' expr
     {275, 3}, // 24: expr (ASSIGN_ADD) ->  expr ASSIGN_ADD expr
     {275, 3}, // 25: expr (ASSIGN_SUB) ->  expr ASSIGN_SUB expr
     {275, 3}, // 26: expr (ASSIGN_MUL) ->  expr ASSIGN_MUL expr
     {275, 3}, // 27: expr (ASSIGN_DIV) ->  expr ASSIGN_DIV expr
     {275, 3}, // 28: expr (ASSIGN_MOD) ->  expr ASSIGN_MOD expr
     {275, 3}, // 29: expr (ASSIGN_BITLSHIFT) ->  expr ASSIGN_BITLSHIFT expr
     {275, 3}, // 30: expr (ASSIGN_BITRSHIFT) ->  expr ASSIGN_BITRSHIFT expr
     {275, 3}, // 31: expr (ASSIGN_BITOR) ->  expr ASSIGN_BITOR expr
     {275, 3}, // 32: expr (ASSIGN_BITXOR) ->  expr ASSIGN_BITXOR expr
     {275, 3}, // 33: expr (ASSIGN_BITAND) ->  expr ASSIGN_BITAND expr
     {276, 1}, // 34: lines_$ ->  lines
};
...
SR_ s_3[] =
{
    ...
    { {       264}, { 29} }, // ASSIGN_DIV      
    { {       265}, { 30} }, // ASSIGN_MOD      
    { {       266}, { 31} }, // ASSIGN_BITLSHIFT
    { {       267}, { 32} }, // ASSIGN_BITRSHIFT
    { {       268}, { 33} }, // ASSIGN_BITOR    
    { {       269}, { 34} }, // ASSIGN_BITXOR   
    { {       270}, { 35} }, // ASSIGN_BITAND   
    { {         0}, {  0} },                    
};
