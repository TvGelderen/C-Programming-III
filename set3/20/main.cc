...
struct Type<needle, index, Tail ...>
{
    enum
    {
        tmp = Type<needle, Tail...>::located,   // Move to the next index!
                                // If found return the correct index, 0 o.w.
        located = tmp ==  0 ? 0 : 1 + tmp
    };
};
...
struct Type<needle>
{
    enum
    {
        located = 0             // Needle was not found
    };
};
