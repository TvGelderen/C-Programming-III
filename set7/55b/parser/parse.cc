...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 0}, // 1: input ->  <empty>
     {259, 3}, // 2: input ('\x0a') ->  input line '\x0a'
     {259, 2}, // 3: input ('\x0a') ->  input '\x0a'
     {260, 2}, // 4: line ('m') ->  'm' IntOrDouble
     {260, 2}, // 5: line ('s') ->  's' IntOrDouble
     {260, 1}, // 6: line ->  IntOrDouble
     {260, 2}, // 7: line (INT) ->  IntOrDouble INT
     {261, 1}, // 8: IntOrDouble (DOUBLE) ->  DOUBLE
     {261, 1}, // 9: IntOrDouble (INT) ->  INT
