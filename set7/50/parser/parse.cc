// Generated by Bisonc++ V6.02.04 on Thu, 25 Mar 2021 19:45:40 +0000
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 2}, // 4: line ('\x0a') ->  expr '\x0a'
     {262, 1}, // 5: expr (NUMBER) ->  NUMBER
     {262, 3}, // 6: expr ('+') ->  expr '+' expr
     {262, 3}, // 7: expr ('-') ->  expr '-' expr
     {262, 3}, // 8: expr ('*') ->  expr '*' expr
     {262, 3}, // 9: expr ('/') ->  expr '/' expr
     {262, 2}, // 10: expr (NEG) ->  '-' expr
     {262, 2}, // 11: expr (SQUARE) ->  '$' expr
     {262, 3}, // 12: expr ('(') ->  '(' expr ')'
     {263, 1}, // 13: input_$ ->  input
};
