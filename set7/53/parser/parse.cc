// Generated by Bisonc++ V6.03.00 on Sat, 27 Mar 2021 18:33:33 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 1}, // 1: expr (NR) ->  NR
     {259, 1}, // 2: expr (IDENT) ->  IDENT
     {259, 2}, // 3: expr ->  expr indexes
     {259, 2}, // 4: expr ('-') ->  '-' expr
     {259, 3}, // 5: expr ('+') ->  expr '+' expr
     {259, 3}, // 6: expr ('*') ->  expr '*' expr
     {260, 2}, // 7: indexes ->  indexes index
     {260, 1}, // 8: indexes ->  index
     {261, 3}, // 9: index ('[') ->  '[' expr ']'
     {262, 1}, // 10: expr_$ ->  expr
};
