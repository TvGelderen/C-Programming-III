// Generated by Bisonc++ V6.03.00 on Sat, 27 Mar 2021 18:25:19 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 0}, // 2: line ->  <empty>
     {260, 1}, // 3: expr (NR) ->  NR
     {260, 1}, // 4: expr (IDENT) ->  IDENT
     {260, 2}, // 5: expr ->  expr indexes
     {260, 2}, // 6: expr ('-') ->  '-' expr
     {260, 3}, // 7: expr ('+') ->  expr '+' expr
     {260, 3}, // 8: expr ('*') ->  expr '*' expr
     {261, 2}, // 9: indexes ->  indexes index
     {261, 1}, // 10: indexes ->  index
     {262, 3}, // 11: index ('[') ->  '[' expr ']'
     {263, 1}, // 12: line_$ ->  line
};
