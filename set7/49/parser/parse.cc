// Generated by Bisonc++ V6.02.04 on Wed, 24 Mar 2021 20:02:18 +0000
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: startSymbol ->  startSymbol write
     {260, 0}, // 2: startSymbol ->  <empty>
     {261, 2}, // 3: write (WRITE) ->  WRITE enclosedArgList
     {262, 3}, // 4: enclosedArgList ('(') ->  '(' arglist ')'
     {263, 3}, // 5: arglist (',') ->  arglist ',' arg
     {263, 1}, // 6: arglist ->  arg
     {264, 1}, // 7: arg (IDENT) ->  IDENT
     {264, 1}, // 8: arg (NUMBER) ->  NUMBER
     {265, 1}, // 9: startSymbol_$ ->  startSymbol
};
...
SMapVal s_symArr[] =
{
    ...
    SMapVal(258, "IDENT"),
    SMapVal(259, "NUMBER"),
    SMapVal(260, "startSymbol"),
    SMapVal(261, "write"),
    SMapVal(262, "enclosedArgList"),
    SMapVal(263, "arglist"),
    SMapVal(264, "arg"),
    SMapVal(265, "startSymbol_$"),
};
