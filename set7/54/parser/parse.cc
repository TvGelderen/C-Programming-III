// Generated by Bisonc++ V6.02.04 on Thu, 25 Mar 2021 22:12:09 +0000
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 2}, // 1: list (WORD) ->  WORD plain
     {258, 3}, // 2: list (WORD) ->  WORD ',' separated
     {258, 1}, // 3: list (WORD) ->  WORD
     {258, 0}, // 4: list ->  <empty>
     {259, 2}, // 5: plain (WORD) ->  plain WORD
     {259, 1}, // 6: plain (WORD) ->  WORD
     {260, 3}, // 7: separated (',') ->  separated ',' WORD
     {260, 1}, // 8: separated (WORD) ->  WORD
     {261, 1}, // 9: list_$ ->  list
};
