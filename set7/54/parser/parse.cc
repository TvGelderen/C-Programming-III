// Generated by Bisonc++ V6.02.04 on Sat, 27 Mar 2021 10:53:53 +0000
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 0}, // 3: list ->  <empty>
     {259, 2}, // 4: plain (WORD) ->  plain WORD
     {259, 1}, // 5: plain (WORD) ->  WORD
     {260, 3}, // 6: separated (',') ->  separated ',' WORD
     {260, 1}, // 7: separated (WORD) ->  WORD
     {261, 1}, // 8: list_$ ->  list
};
